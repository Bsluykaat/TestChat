...
import com.work.testchat.databinding.FragmentMyMessageBinding;
...
public class MyMessageFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binder = FragmentMyMessageBinding.inflate(inflater, container, false);
        v = binder.getRoot();
        Valuation();
        return v;
    }
